...
Reads model, provider, and lab information from models.dev.
...
Commands:
  ...
  model     <id>         Show full detail for one model, merged across providers.
...
func main() {
	...
	reg, err := llmreg.BuildRegistry(opts)
	if err != nil {
